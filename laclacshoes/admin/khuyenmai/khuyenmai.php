			 ...
			 <?php $so=0;
				 while ($row=mysqli_fetch_array($rs)) { ?>
					<tr>
						...
						<td><a href="index.php?action=khuyenmai&view=sua&makm=<?php echo $row['MaKM']; ?>" ><i class="far fa-edit"></i>Sửa</a></td> <!-- sửa-->		
						<td><a href="index.php?action=khuyenmai&view=apply&makm=<?php echo $row['MaKM']; ?>" >APPLY</a></td>
						<td><a href="khuyenmai/xuly.php?xoa=xoa&makm=<?php echo $row['MaKM']; ?>" ><i class="fas fa-backspace"></i>Xóa</a></td><!-- xóa-->	
					</tr>
			 <?php	} ?>
