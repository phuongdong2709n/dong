			 ...
			 <?php $so=0;
				 while ($row=mysqli_fetch_array($rs)) { ?>
					<tr>
						...
						<td><a href="index.php?action=nhanvien&view=sua&manv=<?php echo $row['MaNV']; ?>" ><i class="far fa-edit"></i>Sửa</a></td>
						<td><a href="nhanvien/xuly.php?xoa&manv=<?php echo $row['MaNV']; ?>" ><i class="fas fa-backspace"></i>Xóa</a></td>	
					</tr>
			 <?php	} ?>		
				</tbody>
			</table><hr>
