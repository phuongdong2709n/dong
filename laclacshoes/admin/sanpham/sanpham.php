	 ...
	 <?php $so=0;
		 while ($row=mysqli_fetch_array($rs)) { ?>
			<tr>
				...
				<td><a href="index.php?action=sanpham&view=suasp&masp=<?php echo $row['MaSP']; ?>" ><i class="far fa-edit"></i>Sửa</a></td>
				<td><a href="sanpham/main.php?view=xoasp&masp=<?php echo $row['MaSP']; ?>" ><i class="fas fa-backspace"></i>Xóa</a></td>
			</tr>
	 <?php	} ?>
