	 ...
	 <?php $so=0;
		 while ($row=mysqli_fetch_array($rs)) { ?>
			<tr>
				...
				<td><a href="index.php?action=danhmuc&view=suadm&madm=<?php echo $row['MaDM']; ?>" ><i class="far fa-edit"></i>Sửa</a></td>
				<td><a href="danhmuc/main.php?view=xoadm&madm=<?php echo $row['MaDM']; ?>" ><i class="fas fa-backspace"></i>Xóa</a></td>
			</tr>
	 <?php	} ?>
